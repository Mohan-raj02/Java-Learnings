...
public class OurGenericList<T> implements Iterable<T> {  // Iterable is the interface that used to access iteration for the created class That means Java knows how to “walk through” each element one by one.
    private int size;
    private T[] arr;
